...
contract RIFDepositTest is Test {
    ...
    bytes constant RUSDT_TO_RIF_CALLDATA = hex"";
    
    bytes constant USDT_TO_RIF_CALLDATA = hex"";
    ...
    function testExecuteCallsAndDepositWithRUSDT() public {
        ...
        uint256 allowance = IERC20(RUSDT_TOKEN).allowance(WHALE, address(rifContract));
        ...
        assertEq(finalRUSDTBalance, initialRUSDTBalance - approveAmount, "RUSDT should have been consumed");
    ...
    function testBothSwapsInOneCall() public {
        ...
        assertEq(finalRUSDTBalance, initialRUSDTBalance - rusdtAmount, "RUSDT should have been consumed");
        assertEq(finalUSDTBalance, initialUSDTBalance - usdtAmount, "USDT should have been consumed");
        
        // 2. Contract should have 0 RIF (deposited to staking)
        assertEq(finalRIFBalance, 0, "Contract should have 0 RIF after depositing to staking");
        
        console.log("SUCCESS: Full flow completed - Both tokens -> RIF -> Staked!");
    }
}
