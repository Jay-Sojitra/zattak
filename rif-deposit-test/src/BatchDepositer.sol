...
contract RIFBatchDepositer {
    ...
    function executeCallsAndDeposit(
        ...
        // mockkkkkkkkkkkkkkkkkkkkkk approve
        ...
        // uint256 userRifBalanceBefore = IERC20(tRIF_TOKEN).balanceOf(msg.sender);
        

        // mockkkkkkkkkkkkkkkkkkkkkk call
        ...
        // uint256 userRifBalanceAfter = IERC20(tRIF_TOKEN).balanceOf(msg.sender);
        // uint256 tRIFReceived = userRifBalanceAfter - userRifBalanceBefore;

        uint256 tRIFReceived = 10000000000000000000;
